                             ...
                             sdf::ElementPtr _sdf)
{
  ...
  // Broadcasts state.
  this->pubHandleStateQueue = this->pmq.addPub<grizzly_ur10_gazebo_plugins::SModelRobotInput>();
  this->pubHandleState = this->rosNode->advertise<grizzly_ur10_gazebo_plugins::SModelRobotInput>(
  ...
  ros::SubscribeOptions handleCommandSo =
    ros::SubscribeOptions::create<grizzly_ur10_gazebo_plugins::SModelRobotOutput>(
