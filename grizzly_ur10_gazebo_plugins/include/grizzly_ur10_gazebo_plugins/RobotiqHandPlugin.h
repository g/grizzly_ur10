...
#include <grizzly_ur10_gazebo_plugins/SModelRobotInput.h>
#include <grizzly_ur10_gazebo_plugins/SModelRobotOutput.h>
...
class RobotiqHandPlugin : public gazebo::ModelPlugin
{
  ...
  private: void SetHandleCommand(
    const grizzly_ur10_gazebo_plugins::SModelRobotOutput::ConstPtr &_msg);
  ...
  private: bool VerifyCommand(
    const grizzly_ur10_gazebo_plugins::SModelRobotOutput::ConstPtr &_command);
  ...
  private: grizzly_ur10_gazebo_plugins::SModelRobotOutput handleCommand;

  /// \brief HandleControl message. Last command received before changing the
  /// grasping mode.
  private: grizzly_ur10_gazebo_plugins::SModelRobotOutput lastHandleCommand;
  ...
  private: grizzly_ur10_gazebo_plugins::SModelRobotOutput prevCommand;

  /// \brief Original HandleControl message (published by user and unmodified).
  private: grizzly_ur10_gazebo_plugins::SModelRobotOutput userHandleCommand;
  ...
  private: grizzly_ur10_gazebo_plugins::SModelRobotInput handleState;
  ...
  private: PubQueue<grizzly_ur10_gazebo_plugins::SModelRobotInput>::Ptr pubHandleStateQueue;
